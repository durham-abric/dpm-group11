...
public class Localisation {
	...
	public Localisation (Odometer odo,  SampleProvider usSensor, float[] usData, LocalizationType locType, Navigator navigator) {
		this.odo = odo;
	...
	public void doLocalization() {
		...
		odo.setPosition(new double [] {0.0, 0.0, odo.getTheta()+angleNorth}, new boolean [] {false, false, true});
